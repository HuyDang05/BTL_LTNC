...
void MainObject:: HandleInputAction(SDL_Event events){
    if(events.type == SDL_KEYDOWN){
        ...
        switch (events.key.keysym.sym)
        {
        case SDLK_w: y_val_ += HEIGHT_MAIN_OBJECT/8;
            break;
        case SDLK_s:  y_val_ -= HEIGHT_MAIN_OBJECT/8;
            break;
        case SDLK_a: x_val_ += WIDTH_MAIN_OBJECT/8;
            break;
        case SDLK_d: x_val_ -= WIDTH_MAIN_OBJECT/8;
            break;
